...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question": "Is the seafood in Halden Bay fresh?", "expects": "Yes, Halden Bays's seafood is fresh."},
    {"question": "What are Kestrelford's pub opening and closing hours?", "expects": "Opens at 12 and closes at 8:30."},
    {"question": "How many minutes does the journey from Brightwater to the regional hub take?", "expects": "50 minutes"},
    {"question": "Is it cheaper to book a ticket to the regional hub the day before or on the day of travel?", "expects": "Tickets are cheaper booked the day before, than the day of."},
    {"question": "Which months are recommended for visiting?", "expects": "January through March."},
]
